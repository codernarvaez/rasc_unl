...
abstract class AuthRemoteRepository {
  ...
  Future<UserApiResponse> updateCurrentUser(String accessToken, Map<String, dynamic> updates);
  
  /// Obtiene todos los usuarios (solo admin)
  Future<List<UserApiResponse>> getAllUsers(String accessToken, {
    int skip = 0,
    int limit = 100,
    String? role,
    bool? isActive,
  ...
  Future<UserApiResponse> getUserById(String accessToken, int userId);
  
  /// Actualiza un usuario (solo admin)
  Future<UserApiResponse> updateUser(String accessToken, int userId, Map<String, dynamic> updates);
  
  /// Activa un usuario (solo admin)
  Future<UserApiResponse> activateUser(String accessToken, int userId);
  
  /// Desactiva un usuario (solo admin)
  Future<UserApiResponse> deactivateUser(String accessToken, int userId);
}
