...
class _MyRecordsPageState extends State<MyRecordsPage> {
  ...
  List<RecordData> records = [
    RecordData(
      competenceName: 'Gran Premio 2024',
      position: 1,
      time: Duration(minutes: 15, seconds: 30, milliseconds: 450),
      nTurns: 10,
      date: DateTime(2024, 11, 10),
      totalParticipants: 25,
    ),
    RecordData(
      competenceName: 'Carrera Nocturna',
      position: 3,
      time: Duration(minutes: 22, seconds: 15, milliseconds: 120),
      nTurns: 8,
      date: DateTime(2024, 10, 25),
      totalParticipants: 18,
    ),
    RecordData(
      competenceName: 'Desafío Extremo',
      position: 5,
      time: Duration(minutes: 18, seconds: 45, milliseconds: 890),
      nTurns: 12,
